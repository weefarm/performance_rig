...
│                                                                             │
│   ════════════════════════════════════════════════════════════│═══════════  │
│   Board Box Passthrough (1x IN, 1x OUT)                       │             │
│   ────────────────────────────────────────────────────────────│───────────  │
│                                                               │             │
│                ┌──────────────────────────────────┐           │             │
│                │            mioXM HUB             │           │             │
│                │                                  │◀──────────┘             │
│                │ [DIN IN 1] (Floor Ring Return)   │                         │
│                │                                  │                         │
│   ┌──────────┐ │                                  │          ┌──────────┐   │
│   │   MIDI   │ │ [OUT 2] (HRP / Ring Start)       │─────────▶│  GCP IN  │   │
│   │   PASS   │◀┤                                  │          └──────────┘   │
│   │   [OUT]  │ │                                  │                         │
│   └──────────┘ │                                  │                         │
│                │                                  │          ┌──────────┐   │
│   ┌──────────┐ │                                  │◀─────────│  QC OUT  │   │
│   │ QuadCrtx │ │ [DIN IN 2] (QC Producer)         │          └──────────┘   │
│   │  [IN]    │◀┤                                  │                         │
│   └──────────┘ │ [OUT 1] (QC Consumer)            │                         │
│                │                                  │                         │
│                │                                  │                         │
│   ┌──────────┐ │                                  │          ┌──────────┐   │
│   │ Micrcosm │ │ [DIN IN 3] (MC Producer)         │◀─────────│  MC OUT  │   │
│   │  [IN]    │◀┤                                  │          └──────────┘   │
│   └──────────┘ │ [OUT 3] (MC Consumer)            │                         │
│                │                                  │                         │
│                │ [OUT 4 / DIN IN 4] (Available)   │                         │
│                └──────────────────────────────────┘                         │
│                                                                             │
│                                                                             │
│                          ┌─────────────┐                                    │
